...
var util = require('util'),
    ...
    ControllerOutput = require('./controller_output');
...
var Controller = function() {
    ...
    // function(rumbleLeft, rumbleRight) {
    //     if(controllerConfig.output) {
    //         var writePackageCopy = controllerConfig.output.writePackage.splice(0);

    //         writePackageCopy[controllerConfig.output.rumbleMotors.left] = rumbleLeft;
    //         writePackageCopy[controllerConfig.output.rumbleMotors.right] = rumbleRight;

    //     }
    //     if (device.write) {
    //         console.log(writePackageCopy);
    //         device.write(writePackageCopy);
    //         // device.write([
    //         //     0x01, 0x00, 0xfe, rumbleLeft, 0xfe, rumbleRight, 0x00, 0x00, 0x00, 0x00, 0x00,
    //         //     0xff, 0x27, 0x10, 0x00, 0x32, 0xff, 0x27, 0x10, 0x00, 0x32, 0xff,
    //         //     0x27, 0x10, 0x00, 0x32, 0xff, 0x27, 0x10, 0x00, 0x32, 0x00, 0x00,
    ...
    try {
        ...
        controllerOutput = new ControllerOutput(device);
        this.rumble = controllerOutput.rumble;
        this.led = controllerOutput.led;
        this.ledOn = controllerOutput.ledOn;
        this.ledOff = controllerOutput.ledOff;
