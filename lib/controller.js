...
var controller = function () {
    ...
    */
    ...
    this.init = function (controllerConfig, options) {

        //init the private members;
        controllerConfiguration = controllerConfig;

        if (controllerConfiguration.motionInputs) {
            motionProcessor.init(this, controllerConfiguration.motionInputs, options.accelerometerSmoothing);
        }

        if (controllerConfiguration.analogSticks) {
            analogProcessor.init(this, controllerConfiguration.analogSticks, options.analogStickSmoothing);
        }
