...
var motionProcessor = function(eventEmmiter) {
    ...
    _.forEach(motionInputConfiguration, function(motionAxis) {
    ...
    var processAxis = function(motionAxis, data) {
        ...
        if (dsutilities.isWithinVariance(lastPosition, motionValue.value, varianceThreshhold)) {
            ...
            _.forEach(motionAxis.eventPrefixes, function(eventPrefix) {
                eventEmmiter.emit(eventPrefix + ':motion', motionValue);
            });
        }
    };
