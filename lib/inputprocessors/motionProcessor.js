...
var motionProcessor = function () {
    ...
    */
    var processAxis = function (motionAxis, data) {
        ...
        if(ds3Utilities.isWithinVariance(smoothAnalog.readLastPosition(motionAxis.name), motionValue.value, varianceThreshhold)) {
            ...
            motionValue.value = smoothAnalog.smooth(motionAxis.name, motionValue.value);
